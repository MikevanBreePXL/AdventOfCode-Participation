        ...
        for r in ranges:
            ...
            for number in range(start, end + 1):
                ...
                if str_num[len(str_num) // 2:] == str_num[:len(str_num) // 2]:
                    # Found a number made up of two identical halves
                    total_count += number
